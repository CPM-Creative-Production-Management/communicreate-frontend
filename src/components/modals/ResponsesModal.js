        ...
        <Modal.Body>
            {reqAgencies?.map((currAgency, index) => (
                <Card className='p-4' fluid>
                    ...
                    {currAgency.cost ? <Button onClick={() => navigate('/request/company/response/' + currAgency.estimationId)}>View Estimation</Button>: <Button disabled>View Estimation</Button>}
